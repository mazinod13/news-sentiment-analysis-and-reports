"""Per-outlet test for Karnali Mission. This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save karnalimission_story.html and fill in the selector pack")
