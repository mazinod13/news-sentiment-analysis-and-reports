"""Per-outlet test for Himalpress-karnali. This file is yours alone -- no one else edits it.
...
SOURCE_ID = "himalpress-province-6"
...
@pytest.mark.skip(reason="TODO: save himalpress-province-6_story.html and fill in the selector pack")
