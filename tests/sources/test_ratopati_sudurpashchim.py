"""Per-outlet test for ratopati-sudurpashchim. This file is yours alone -- no one else edits it.
...
SOURCE_ID = "ratopati-sudurpashchim"
...
@pytest.mark.skip(reason="TODO: save ratopati-sudurpashchim_story.html and fill in the selector pack")
