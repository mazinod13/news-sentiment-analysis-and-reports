"""Per-outlet test for Madhesh Province OCMCM.
...
SOURCE_ID = "ocmcm-madhesh"
LISTING_URL = "https://ocmcm.madhesh.gov.np/category/notifications/"
LISTING_FIXTURE = f"{SOURCE_ID}_listing.html"
STORY_FIXTURE = f"{SOURCE_ID}_story.html"

EXPECTED_ITEMS = 9
FIRST_TITLE_HEAD = 'अन्तरस्थानीय तह सरुवा निवेदन पेश ग'
FIRST_DATE_RAW = '१८ भदौ, २०८३'
