"""Per-outlet test for Himal Press. This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save himalpress_story.html and fill in the selector pack")
