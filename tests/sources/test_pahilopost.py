"""Per-outlet test for Pahilopost. This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save pahilopost_story.html and fill in the selector pack")
