"""Per-outlet test for The Kathmandu Post. This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save kathmandupost_story.html and fill in the selector pack")
