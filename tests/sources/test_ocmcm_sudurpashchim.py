"""Per-outlet test for Sudurpashchim Province OCMCM.
...
SOURCE_ID = "ocmcm-sudurpashchim"
LISTING_URL = "https://ocmcm.sudurpashchim.gov.np/category/information"
LISTING_FIXTURE = f"{SOURCE_ID}_listing.html"
STORY_FIXTURE = f"{SOURCE_ID}_story.html"

EXPECTED_ITEMS = 9
FIRST_TITLE_HEAD = 'मानव अधिकार पुरस्कार सम्बन्धी सूचन'
FIRST_DATE_RAW = '१० भदौ, २०८३'
FIRST_DATE_ISO = "2026-08-26"
