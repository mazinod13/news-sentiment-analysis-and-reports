"""Per-outlet test for Image Channel. This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save imagechannel_story.html and fill in the selector pack")
