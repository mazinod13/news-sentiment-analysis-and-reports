"""Per-outlet test for Office of PM & Council of Ministers.
...
SOURCE_ID = "opmcm"
LISTING_URL = "https://opmcm.gov.np/category/cabinet-decision/"
LISTING_FIXTURE = f"{SOURCE_ID}_listing.html"
STORY_FIXTURE = f"{SOURCE_ID}_story.html"

EXPECTED_ITEMS = 4
FIRST_TITLE_HEAD = 'सरसफाई सम्बन्धी कार्यका लागि बोलपत'
FIRST_DATE_RAW = '१९ भदौ, २०८३'
FIRST_DATE_ISO = "2026-09-04"
