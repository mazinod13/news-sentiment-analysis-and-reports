"""Per-outlet test for ratopati-gandaki. This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save ratopati-gandaki_story.html and fill in the selector pack")
