"""Per-outlet test for Himal Press (Bagmati Province). This file is yours alone -- no one else edits it.
...
SOURCE_ID = "himalpress_province3"
...
@pytest.mark.skip(reason="TODO: save himalpress_province3_story.html and fill in the selector pack")
