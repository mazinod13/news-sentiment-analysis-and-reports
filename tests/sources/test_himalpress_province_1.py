"""Per-outlet test for Himalpress-Koshi. This file is yours alone -- no one else edits it.
...
SOURCE_ID = "himalpress-province-1"
...
@pytest.mark.skip(reason="TODO: save himalpress-province-1_story.html and fill in the selector pack")
