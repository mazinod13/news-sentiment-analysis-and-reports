"""Per-outlet test for OnlineKhabar (Nepali). This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save onlinekhabar_nepali_story.html and fill in the selector pack")
