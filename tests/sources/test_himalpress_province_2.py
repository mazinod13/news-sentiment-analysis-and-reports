"""Per-outlet test for Himalpress-madhesh. This file is yours alone -- no one else edits it.
...
SOURCE_ID = "himalpress-province-2"
...
@pytest.mark.skip(reason="TODO: save himalpress-province-2_story.html and fill in the selector pack")
