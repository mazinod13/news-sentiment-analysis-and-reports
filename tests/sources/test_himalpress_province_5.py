"""Per-outlet test for Himalpress-lumbini. This file is yours alone -- no one else edits it.
...
SOURCE_ID = "himalpress-province-5"
...
@pytest.mark.skip(reason="TODO: save himalpress-province-5_story.html and fill in the selector pack")
