"""Per-outlet test for Himalpress-sudurpaschim. This file is yours alone -- no one else edits it.
...
SOURCE_ID = "himalpress-province-7"
...
@pytest.mark.skip(reason="TODO: save himalpress-province-7_story.html and fill in the selector pack")
