"""Per-outlet test for Koshi Province OCMCM.
...
SOURCE_ID = "ocmcm-koshi"
LISTING_URL = "https://ocmcm.koshi.gov.np/category/notice-publication/"
LISTING_FIXTURE = f"{SOURCE_ID}_listing.html"
STORY_FIXTURE = f"{SOURCE_ID}_story.html"

EXPECTED_ITEMS = 8
FIRST_TITLE_HEAD = 'विज्ञप्ति'
FIRST_DATE_RAW = '११ भदौ, २०८३'
