"""Per-outlet test for Khabarhub (Nepali). This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save khabarhub_nepali_story.html and fill in the selector pack")
