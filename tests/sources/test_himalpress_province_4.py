"""Per-outlet test for Himalpress-gandaki. This file is yours alone -- no one else edits it.
...
SOURCE_ID = "himalpress-province-4"
...
@pytest.mark.skip(reason="TODO: save himalpress-province-4_story.html and fill in the selector pack")
