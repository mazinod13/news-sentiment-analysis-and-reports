"""Per-outlet test for Ministry of Foreign Affairs.
...
SOURCE_ID = "mofa"
LISTING_URL = "https://mofa.gov.np/category/presscategory/"
LISTING_FIXTURE = f"{SOURCE_ID}_listing.html"
STORY_FIXTURE = f"{SOURCE_ID}_story.html"

EXPECTED_ITEMS = 6
FIRST_TITLE_HEAD = 'Daily Situation Update on Bhote Ko'
FIRST_DATE_RAW = 'September 08, 2026, 02:00 PM'
FIRST_DATE_ISO = "2026-09-08"
...
def test_body_matches_this_hosts_documented_shape(outlet, story_html):
    ...
    This host is the exception in its CMS family: article pages carry
    full prose, 7k-11k characters across four sampled articles.
    """
    _, selectors = outlet
