"""Per-outlet test for Gorkhapatra. This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save gorkhapatra_story.html and fill in the selector pack")
