"""Per-outlet test for Inland Revenue Department.
...
SOURCE_ID = "ird"
LISTING_URL = "https://ird.gov.np/category/notice/"
LISTING_FIXTURE = f"{SOURCE_ID}_listing.html"
STORY_FIXTURE = f"{SOURCE_ID}_story.html"

EXPECTED_ITEMS = 7
FIRST_TITLE_HEAD = 'आर्थिक ऐन, २०८३ बमोजिमका कर छुट, स'
FIRST_DATE_RAW = '२२ भदौ, २०८३'
FIRST_DATE_ISO = "2026-09-07"
