"""Per-outlet test for Ratopati Koshi. This file is yours alone -- no one else edits it.
...
SOURCE_ID = "ratopati-koshi"
LISTING_URL = "https://koshi.ratopati.com"
...
def test_listing_yields_unique_absolute_story_urls(outlet, listing_html):
    ...
    # "https://koshi.ratopati.com/<headline>" -- a URL made out of a headline,
    ...
    assert not any("koshi.ratopati.com" in i.url for i in items)
...
@pytest.mark.skip(reason="TODO: save ratopati-koshi_story.html, then pin body/author/published")
