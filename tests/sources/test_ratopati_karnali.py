"""Per-outlet test for ratopati-karnali. This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save ratopati-karnali_story.html and fill in the selector pack")
