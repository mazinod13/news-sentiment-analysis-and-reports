"""Per-outlet test for BBC Nepali. This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save bbc_nepali_story.html and fill in the selector pack")
