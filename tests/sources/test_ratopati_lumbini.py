"""Per-outlet test for ratopati-lumbini. This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save ratopati-lumbini_story.html and fill in the selector pack")
