"""Per-outlet test for Ratopati Madhesh. This file is yours alone -- no one else edits it.
...
SOURCE_ID = "ratopati-madhesh"
LISTING_URL = "https://madhesh.ratopati.com"
...
def test_listing_yields_unique_absolute_story_urls(outlet, listing_html):
    ...
    # "https://madhesh.ratopati.com/<headline>" -- a URL made out of a headline,
    ...
    assert not any("madhesh.ratopati.com" in i.url for i in items)
...
@pytest.mark.skip(reason="TODO: save ratopati-madhesh_story.html, then pin body/author/published")
