"""Per-outlet test for Setopati. This file is yours alone -- no one else edits it.
...
@pytest.mark.skip(reason="TODO: save setopati_story.html and fill in the selector pack")
